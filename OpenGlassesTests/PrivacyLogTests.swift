    ...
    private func allEvents(with text: String) -> [PrivacyEvent] {
        [
            ...
            PrivacyLog.modelCompaction(messagesBefore: 40, messagesAfter: 12,
                                       ...
                                       detail: PrivacyToken(text)),
            PrivacyLog.memoryContext(.assembled, route: PrivacyToken(text),
                                     availability: PrivacyToken(text), reason: PrivacyToken(text),
                                     stored: 40, retrieved: 12, included: 8, characters: text.count,
                                     tokens: 78, truncation: PrivacyToken(text), dropped: 4,
                                     clamped: 1, freshness: PrivacyToken(text), ageSeconds: 12.5),
