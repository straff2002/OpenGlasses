...
**Builds on:** the existing [`ChatInputBar`](../../OpenGlasses/Sources/App/Views/VoiceTab.swift) (text + photo attach, vision-gated), [`ConversationStore`](../../OpenGlasses/Sources/Services/ConversationStore.swift) (threads + messages, active-thread tracking, resume/replay), `ConversationHistoryView` (`MessageBubble` + thread list; since replaced by [ChatListView.swift](../../OpenGlasses/Sources/App/Views/Chat/ChatListView.swift) and [MessageBubble.swift](../../OpenGlasses/Sources/App/Views/Chat/MessageBubble.swift)), [`MainView`](../../OpenGlasses/Sources/App/Views/MainView.swift) tab bar, and [`LLMService.sendMessage`](../../OpenGlasses/Sources/Services/LLMService.swift).
